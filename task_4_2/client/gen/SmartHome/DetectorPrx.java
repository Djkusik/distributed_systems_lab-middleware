...
public interface DetectorPrx extends DevicePrx
{
    default float getReading()
        throws DeviceIsOffException,
               LackOfDataException
    {
        return getReading(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default float getReading(java.util.Map<String, String> context)
        throws DeviceIsOffException,
               LackOfDataException
    {
        try
        {
            return _iceI_getReadingAsync(context, true).waitForResponseOrUserEx();
        }
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Float> getReadingAsync()
    {
        return _iceI_getReadingAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Float> getReadingAsync(java.util.Map<String, String> context)
    {
        return _iceI_getReadingAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Float> _iceI_getReadingAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Float> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getReading", null, sync, _iceE_getReading);
    ...
    /** @hidden */
    static final Class<?>[] _iceE_getReading =
    {
        DeviceIsOffException.class,
        LackOfDataException.class
    };

    default float[] getAllReadings()
        throws DeviceIsOffException,
               LackOfDataException
    {
        return getAllReadings(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default float[] getAllReadings(java.util.Map<String, String> context)
        throws DeviceIsOffException,
               LackOfDataException
    {
        try
        {
            return _iceI_getAllReadingsAsync(context, true).waitForResponseOrUserEx();
        }
        catch(DeviceIsOffException ex)
        {
            throw ex;
    ...
    default java.util.concurrent.CompletableFuture<float[]> getAllReadingsAsync()
    {
        return _iceI_getAllReadingsAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<float[]> getAllReadingsAsync(java.util.Map<String, String> context)
    {
        return _iceI_getAllReadingsAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<float[]> _iceI_getAllReadingsAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<float[]> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getAllReadings", null, sync, _iceE_getAllReadings);
        f.invoke(true, context, null, null, istr -> {
                     float[] ret;
    ...
    /** @hidden */
    static final Class<?>[] _iceE_getAllReadings =
    {
        DeviceIsOffException.class,
        LackOfDataException.class
    };
